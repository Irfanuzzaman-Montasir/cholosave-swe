...
<body class="bg-gray-50">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="bkash_number" placeholder="Enter bKash number"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-1 focus:ring-green-500 focus:border-green-500">
                        <div class="error-message" id="bkash_number_error"></div>
                    </div>
                    <div>
                        ...
                        <input type="text" name="rocket_number" placeholder="Enter Rocket number"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-1 focus:ring-green-500 focus:border-green-500">
                        <div class="error-message" id="rocket_number_error"></div>
                    </div>
                    <div>
                        ...
                        <input type="text" name="nagad_number" required placeholder="Enter Nagad number"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-1 focus:ring-green-500 focus:border-green-500">
                        <div class="error-message" id="nagad_number_error"></div>
                    </div>
                </div>
                <div class="flex justify-between">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateStep3() {
            ...
            // Validate Nagad number (required)
            if (!validateInput('nagad_number', { required: true })) {
                isValid = false;
            }

            // Validate bKash number (optional)
            const bkashInput = document.querySelector('[name="bkash_number"]');
            if (bkashInput.value.trim()) {
                if (!validateInput('bkash_number', { required: false })) {
                    isValid = false;
                }
            }

            // Validate Rocket number (optional)
            const rocketInput = document.querySelector('[name="rocket_number"]');
            if (rocketInput.value.trim()) {
                if (!validateInput('rocket_number', { required: false })) {
                    isValid = false;
                }
            }
