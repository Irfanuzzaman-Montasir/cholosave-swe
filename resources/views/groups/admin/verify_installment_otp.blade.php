...
@section('title', 'Admin - Verify OTP')
...
<div class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md p-8 space-y-8 bg-white rounded shadow-lg">
        <h2 class="text-2xl font-bold text-center">Admin OTP Verification</h2>
        ...
        <form method="POST" action="{{ route('admin.installment.payment.verify-otp.post', ['groupId' => $groupId, 'transactionId' => $transactionId]) }}" class="space-y-6">
            @csrf
            <div>
        ...
        <div class="text-center">
            <a href="{{ route('admin.installment.payment.create', $groupId) }}" class="text-sm text-blue-600 hover:underline">
                Cancel Payment
            </a>
        </div>
    </div>
