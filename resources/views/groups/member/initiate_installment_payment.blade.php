...
@section('title', 'Initiate Installment Payment')

@push('styles')
<style>
    /* Add any custom styles from payment-page.php here if not covered by Tailwind */
    /* Example: custom background image, specific font styles, etc. */
    .payment-background {
    ...
    /* Add styles for payment method buttons if needed */
...
@section('content')
            ...
            <div class="bg-white rounded shadow-sm mt-8" style="background-color: white;">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="pt-4 text-sm text-red-500" style="color: #ef4444;">
                        <a href="{{ route('groups.member.dashboard', $group->group_id) }}" class="hover:underline" style="color: #ef4444;">Cancel Payment & return to Dashboard</a>
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ selectedMethod: '' }" class="bg-white rounded shadow-sm mt-8" style="background-color: white;">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-8">
                        ...
                        <form method="POST" action="{{ route('member.installment.payment.initiate', $group->group_id) }}" id="paymentForm" onsubmit="handleSubmit(event)">
                            @csrf
    ...
    <div class="fixed bottom-4 right-4 ">
        {{-- <img src="{{ asset('images/cholosave-logo.png') }}" class="h-8"> --}} {{-- Replace with your logo --}}
    ...
    <script>
        function handleSubmit(event) {
            ...
            // You might want to adjust this delay or remove it if backend processing is fast
             setTimeout(() => {
